function [FO, FD, cleanUpObj] = ffsa_rw(features, targets, varargin)
    ...
    [FO, FD, cleanUpObj] = feasel_frame(@ffsa_rw_algorithm, features, targets, it_struct, varargin{:});
    
end

function [FO, FD] = ffsa_rw_algorithm(features, target, varargin)
    ...
    if pvStruct.nfeatures > size(aktList,2), pvStruct.nfeatures = size(aktList,2); end
    ...
    FD = mes(1, 1:pvStruct.nfeatures); % kivalasztasi suly, �tlagos k�lcs�n�s inform�ci�
